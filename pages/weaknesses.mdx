...
## Dominance of a Handful of Corporations
...
<div class='mx-auto mt-10 text-sm text-center'>
  <img
    src='/images/vendors.png'
    width='250px'
    class='mx-auto border border-gray-600'
  />
  {/* prettier-ignore */}
  Just 3 companies control 92% of the election technology market
  ([Source](https://web.archive.org/web/20200701025059/https://publicpolicy.wharton.upenn.edu/live/files/270-the-business-of-votin))
</div>
