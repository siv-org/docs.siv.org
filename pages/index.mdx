...
Although SIV is designed to exceed paper across all relevant criteria, it need not be forced upon any voter. It can be offered as an additional option to the choice between In-Person & Vote-by-Mail. Any voter who prefers traditional paper methods can still use them.

## Ready For Use

SIV is operational and has been successfully piloted by thousands of voters in elections throughout the US. If you have an upcoming election, whether governmental or not, SIV exists to make your and your voters' lives easier. [Get Started.](https://siv.org/admin)

## About This Documentation

As a lack of familiarity leads to doubt & mistrust, this documentation serves to illustrate & elaborate the Secure Internet Voting technical design.

Please [provide feedback](mailto:team@siv.org) where things are not yet clear, so that this documentation can be improved for the benefit of all.
