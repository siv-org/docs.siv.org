...
Enhancing the detection of vote selling, accountability and deterrence can be promoted. A pivotal strategy that can be employed is rooted in Game Theory, specifically drawing from the two-party Prisoner's Dilemma:
...
The Prisoner's Dilemma demonstrates that each player's individual interest, represented by the "Nash equilibrium", may lead to constant defection, irrespective of the other party's actions. Similarly, in the context of vote selling, the two parties involved — the vote buyer and the vote seller — face uncertainty regarding mutual trust. Consequently, either party will likely choose to betray the other, disclosing the existence of the vote selling arrangement.

The proposal suggests capitalizing on substantial criminal penalties to generate a powerful incentive for either party to betray the other. Alongside jail time, governments could impose a fine equal to 100 times the agreed-upon vote sale price. Such a measure introduces an enormous risk for potential vote buyers and sellers, effectively deterring their engagement in vote selling schemes.
