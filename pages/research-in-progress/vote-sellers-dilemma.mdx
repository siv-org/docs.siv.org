...
Although all votes are encrypted by default, a quorum of the election's Privacy Protectors can cooperate to selectively deanonymize an individual vote, while still protecting the privacy of all other voters. This means discovered vote sellers cannot hide behind SIV's strong cryptography.
...
By implementing a robust legal framework that heavily penalizes vote selling through high fines and rewards to whistleblowers, we can undermine trust between potential vote buyers and sellers. But this proposal doesn't just deter vote selling, it destroys the foundation it stands on.
