...
People that closely study the issue of internet voting have highlighted the increase potential of vote selling as a unique risk.

Despite common misconceptions, vote selling is already possible with paper voting. For example, it is trivially easy to sign a blank vote-by-mail ballot and hand it over to a vote buyer. But the concern is magnified by internet voting because potential vote buyers can now more easily be located far away, outside law enforcement's jurisdiction, and automated.

There are large number of reasons to be less concerned about vote selling, which we have compiled [here](/mitigating-attacks/vote-selling). But for those who remain unconvinced, we propose the following strong legal solution.
...
To prevent false claims, accusers must provide verifiable proof and identify themselves. The requirement to identify themselves means they face perjury charges for false accusations. By verifiable proof we mean the kind of proof that verifiable internet voting enables in the first place. In other words, this proposal is speciafically for the votes that are at new risk for vote selling because of internet voting.
...
As with the Prisoner's Dilemma, it is consistently better for each party to betray the other. Both sides are aware that defection is also the better choice for their counterpart. As a result, the ability of the two parties to trust each other is destroyed.

Voters who might have considered selling their votes now face high risk of being caught in a honeypot, as the potential for deception and exposure is significantly high.
...
In conclusion, we propose establishing a robust legal framework that incentivizes both parties to defect, making it especially difficult for them to trust each other. Having such system can provide strong assurance that voters will not benefit from attempting to sell their vote.
