...
1. **Data encryption**: When a vote is cast, SIV already encrypts it to protect the private vote content. Adding additional storage has no adverse effect on privacy, because the SIV design does not assume encrypted ciphertexts are private.
