...
Realistically, expecting 100% of voters to manually strengthen & verify is not very practical. But we can statistically approximate this goal, even with only a small fraction of voters strengthening. But first we need to harden our Strengthened Verification Number procedure to be able to detect cheating red-handed.
