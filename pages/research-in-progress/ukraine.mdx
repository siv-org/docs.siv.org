...
President Zelenskyy's 4-year term has now expired.
...
Local polling indicates broad support for Zelenskyy (approximately 60-80%), but there are important distinctions between informal small-scale polls and legitimate nationwide elections.
