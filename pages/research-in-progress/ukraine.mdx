...
The [SIV Protocol](https://docs.siv.org/technical-specifications) has been developed to create far more accessible elections, enabling remote participation, that can also withstand extreme levels of attack. It creates mathematical proof of correctness, using well-vetted computer science and cryptography tools.
