...
Building upon the current criminal penalties against vote selling, SIV has developed an even stronger potential legal solution that addresses vote selling while preserving voter verifiability, called **_["The Vote Seller's Dilemma"](/further-study/vote-sellers-dilemma)_**.
...
For further explanation, see **_["The Vote Seller's Dilemma"](/further-study/vote-sellers-dilemma)_**.
