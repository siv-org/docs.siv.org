...
- add additional considerations: not everyone will answer the call, what are implications(not that many have to reply, so that's a positive aspect)
- how is the math impacted if you do find votes that were tampered with 
