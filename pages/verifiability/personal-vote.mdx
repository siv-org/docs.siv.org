...
After casting your ballot, your device continues to store your personal Verification \# in the browser memory: <img src="/images/verification-num.png" style={{width: "50%" }} className="ml-5 shadow-lg shadow-sky-900/30 my-7"/>
