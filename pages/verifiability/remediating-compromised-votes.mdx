...
If tampering is only discovered after close, see [Reported-Corrupted Sum](/research-in-progress/reported-corrupted-sum) for post-close accounting of voter-reported corruption.
