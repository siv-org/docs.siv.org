...
- [Software Independent Verification Numbers](/research-in-progress/strengthened-verif-nums)

- [Reported-Corrupted Sum](/research-in-progress/reported-corrupted-sum): Protecting against false claims of on-device malware.
...
- [Lower-Barrier Privacy Protectors Design](/research-in-progress/privacy-protectors)
