...
Imagine that once your election administrators confirmed that your vote was successfully received, you have the confidence that it will be in the final tally, and their claim is backed by automatic financial guarantees. This means if you vote on Day 6 of a 30 day voting period, you can have strong confidence that once your vote has been confirmed (on Day 6), you don't need to return back again two weeks later when the voting period ends (on Day 30).

Here's how it works at a high level: After you cast your vote, you receive a signed vote submission receipt via email. If for any reason your vote does not make it into the final tally, you can automatically claim a large financial payoff. Because these are cryptographic claims, paying out rewards can even be automatically enforced and executed with smart contract escrows.
